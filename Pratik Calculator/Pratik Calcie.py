...
LARGE_FONT_STYLE = ("Arial", 40, "bold", "italic")
SMALL_FONT_STYLE = ("Arial", 16)
DIGITS_FONT_STYLE = ("Arial", 24, "bold", "italic")
...
class Calculator:
    def __init__(self, window):
        ...
        self.window.title("Pratik's Calcie")
    ...
    def create_clear_button(self):
        button = tk.Button(self.buttons_frame, text="C",font=DEFAULT_FONT_STYLE,
    ...
    def create_square_button(self):
        button = tk.Button(self.buttons_frame, text="x\u00b2",font=DEFAULT_FONT_STYLE,
    ...
    def create_equals_button(self):
        button = tk.Button(self.buttons_frame, text="=",font=DEFAULT_FONT_STYLE,
...
if __name__ == "__main__":
    ...
    print("Here I present to you the calculator I made of my own !!!")
    ...
    def toggle():
        ...
        if switch_value == True:
            ...
            switch.config(image=light, bg="#FFFFFF",
    ...
    switch = Button(window, image=light,
                    ...
                    activebackground="#FFFFFF",
                    command=toggle)
    switch.pack(anchor="ne", padx=10, pady=10)
